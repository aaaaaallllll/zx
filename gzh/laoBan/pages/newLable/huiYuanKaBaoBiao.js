// pages/newLable/huiYuanKaBaoBiao.js
import {
  Datas
} from '../../utils/data.js'
import {
...
Page({
  ...
  data: {
    ...
    shopTitles: ['月初数量', '月初余额', '本月新增数量', '本月充值金额', '其中赠送金额', '本月刷卡次数', '本月消费金额', '月末数量', '月末金额', '新增储值', '储值率', '消费排名前10名', '一年内有使用的卡数', '近一年未用卡数', '平均每次消费金额', '会员转化率'],
    gradeData: [{
      bumenName: '2015-5-5',
      benRiLeiJi: 0,
      benYueLeiJi: 5,
