  ...
  <div id="vippay">
    <div class="phone_main">
      ...
      <div class="phone_form">
        ...
        <div class="row">
          <span class="tit">验证码(必填)</span>
          <input type="text" class="text"  style="width: 14rem" v-model="yanZhenMa"/>
        </div>
        <div class="row">
          <span class="tit">姓名</span>
          <input type="text" class="text" style="width: 16rem"  v-model="userName"/>
        </div>
        <div class="row">
          <span class="tit">地址</span>
          <input type="text" class="text" style="width: 16rem"  v-model="addr"/>
        </div>
      ...
      <mt-datetime-picker ref="picker" :endDate="startDate"  :startDate="endTime" type="date" v-model="pickerValue"></mt-datetime-picker>
      <!--支付弹窗-->
...
<!--                <span></span>-->
<!--                <p>-->
<!--                  <i class="iconfont" style="color: #e43f49;font-size: 1.4rem;margin-right: .4rem">&#xe605;</i>-->
<!--                  <span>付呗支付</span>-->
<!--                  <span style="color: #d13a3b">￥{{jinE}}</span>-->
<!--                  <span class="kuang iconfont"  v-if="zfIndex==1" style="background-color: #f49b45;color: #FFF">&#xe6b4;</span>-->
<!--                  <span class="kuang " v-else ></span>-->
<!--                </p>-->
<!--              </li>-->
            </ul>
...
<style scoped>
  ...
  *:after {
  ...
  @font-face {
    font-family: 'iconfont';  /* project id 1314785 */
    src: url('//at.alicdn.com/t/font_1314785_xw4jmg1xjz.eot');
    src: url('//at.alicdn.com/t/font_1314785_xw4jmg1xjz.eot?#iefix') format('embedded-opentype'),
    url('//at.alicdn.com/t/font_1314785_xw4jmg1xjz.woff2') format('woff2'),
    url('//at.alicdn.com/t/font_1314785_xw4jmg1xjz.woff') format('woff'),
    url('//at.alicdn.com/t/font_1314785_xw4jmg1xjz.ttf') format('truetype'),
    url('//at.alicdn.com/t/font_1314785_xw4jmg1xjz.svg#iconfont') format('svg');
  }
  .iconfont {
    font-family: "iconfont" !important;
    font-size: 16px;
