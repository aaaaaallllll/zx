...
Page({
  ...
  // 点击房间跳转技师派遣
  gotojishipaiqian(e){
    let list=e.currentTarget.dataset.i;
    let name=list.name;
    let techId=list.techId;
    console.log(list)
    // 跳转到技师派遣
    wx.navigateTo({
      url: `/pages/dispatch/dispatch?name=${name}&techId=${techId}`,
      success: function (res) { },
      fail: function (res) { },
      complete: function (res) { },
    })
  },
  gotojishipaiqian_jishi(e){
    let list = e.currentTarget.dataset.i;
    let name = list.id;
    console.log(list)
    // 跳转到技师派遣,几时只有房间号，没有点钟工号
    wx.navigateTo({
      url: `/pages/dispatch/dispatch?name=${name}`,
      success: function (res) { },
      fail: function (res) { },
      complete: function (res) { },
    })
