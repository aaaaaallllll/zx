...
class Model extends HTTP {
  ...
  // 注册
  xcxBossRegister(phone, smsCode) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'xcxBossRegister',
        phone: phone,
        smsCode: smsCode
      }
    })
  ...
  // 发送验证码
  xcxBossSendCode(phone) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'xcxBossSendCode',
        phone: phone
      }
    })
  }
  // 登录
  xcxBossLogIn(userId, code, pwd) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'xcxBossLogIn',
        userId: userId,
        code: code,
        pwd: pwd
      }
  ...
  // 门店管理
  xcxBossGetShops(userId) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'xcxBossGetShops',
        userId: userId
      }
    })
  }
  // 添加门店
  xcxBossAddShop(userId, companyCode, pwd) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'xcxBossAddShop',
        userId: userId,
  ...
  // 删除门店
  xcxBossDelShop(userId, companyCode) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'xcxBossDelShop',
        userId: userId,
        companyCode: companyCode
      }
    })
  ...
  // 收款统计
  shouKuanTongJi(companyCode, userId, begin, end) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'ShouKuanTongJi',
        userId: userId,
        companyCode: companyCode,
        begin: begin,
        end: end,
  ...
  // 获取手牌列表
  bossGetSeats(userId, companyCode, yeMa) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossGetSeats',
        userId: userId,
        companyCode: companyCode,
        yeMa: yeMa
      }
  ...
  // 获取房间列表
  bossGetRoom(userId, companyCode, roomType, louCeng, roomStatus, yeMa) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossGetRoom',
        userId: userId,
        companyCode: companyCode,
        roomType: roomType,
        louCeng: louCeng,
  ...
  // 区间客流统计表
  quJianKeLiu(companyCode, userId, begin, end, timeType) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'QuJianKeLiu',
        userId: userId,
        companyCode: companyCode,
        begin: begin,
        end: end,
  ...
  // 项目分析
  bossYingYeBaoBiaoFenXi(userId, companyCode, begin, end) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossYingYeBaoBiaoFenXi',
        userId: userId,
        companyCode: companyCode,
        begin: begin,
        end: end
  ...
  // 会员统计分析
  bossHuiYuanTongJi(userId, companyCode) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossHuiYuanTongJi',
        userId: userId,
        companyCode: companyCode,
      }
    })
  ...
  // 技师type
  bossQueryTechTypes(userId, companyCode) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossQueryTechTypes',
        userId: userId,
        companyCode: companyCode,
      }
    })
  ...
  // 根据技师职务查询技师
  bossQueryTechIdByTypes(userId, companyCode, techType) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossQueryTechIdByTypes',
        userId: userId,
        companyCode: companyCode,
        techType: techType
      }
  ...
  // 排行榜
  bossPaiHangBang(userId, companyCode, begin, end) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossPaiHangBang',
        userId: userId,
        companyCode: companyCode,
        begin: begin,
        end: end
  ...
  // 客户分析
  bossKeHuFenXi(userId, companyCode, begin, end) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossKeHuFenXi',
        userId: userId,
        companyCode: companyCode,
        begin: begin,
        end: end
  ...
  // 会员分析
  bossHuiYuanFenXi(userId, companyCode, begin, end) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossHuiYuanFenXi',
        userId: userId,
        companyCode: companyCode,
        begin: begin,
        end: end
  ...
  // 项目销售统计
  bossXiangMuXiaoShouTongJi(userId, companyCode, begin, end, catName, menuName) {
    return this.request({
      url: api.getcode,
      data: {
        operationType: 'queryLocal',
        queryType: 'BossXiangMuXiaoShouTongJi',
        userId: userId,
        companyCode: companyCode,
        begin: begin,
        end: end,
